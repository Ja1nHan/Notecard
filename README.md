...
| 文件 | 说明 |
|------|------|
| `NoteCard_x.x.x_x64-setup.exe` | 安装版，支持自动更新 |
| `NoteCard_x.x.x_x64_portable.zip` | 便携版，解压即用，无需安装 |
...
| File | Description |
|------|-------------|
| `NoteCard_x.x.x_x64-setup.exe` | Installer with auto-update support |
| `NoteCard_x.x.x_x64_portable.zip` | Portable, no installation required |
